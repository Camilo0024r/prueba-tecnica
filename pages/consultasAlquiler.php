  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title text-center">Consultas de Alquiler</h4>
                    <p class="card-description">Realiza tus consultas de <code>alquiler de peliculas</code></p>
                    <form class="form-inline" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    <input type="text" class="form-control mb-2 mr-sm-2" placeholder="ID Pelicula" name="busquedaPelicula">
                      <input type="text" class="form-control mb-2 mr-sm-2" placeholder="ID Cliente" name="busquedaCliente">
                      <input type="text" class="form-control mb-2 mr-sm-2" placeholder="Fecha Alquiler" name="busquedaFecha">
                      <input type="text" class="form-control mb-2 mr-sm-2" placeholder="Fecha Devolución" name="busquedaDevolucion">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        if (isset($_POST['boton1'])) {
                           ...
                           $datosAlquiler = $alquiler->ObtenerAlquiler();     
                    }
                }
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><?php echo $datosAlquiler['ID_CLIENTE'] . "<br>"; ?></td>
                            <td><?php echo $datosAlquiler['ID_PELICULA'] . "<br>"; ?> </td>
                            <td><?php echo $datosAlquiler['FECHA_ALQUILER'] . "<br>"; ?></td>
                            <td><?php echo $datosAlquiler['FECHA_DEVOLUCION'] . "<br>"; ?></td>
                        </tbody>
                      </table>
                    </div>
                  </div>
